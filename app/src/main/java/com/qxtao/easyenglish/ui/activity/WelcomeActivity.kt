...
import com.qxtao.easyenglish.ui.activity.WelcomeActivity.Companion.isForgotPasswordFragmentDisplay
...
class WelcomeActivity: BaseActivity<ActivityWelcomeBinding>(ActivityWelcomeBinding::inflate),
    ...
    companion object{
        @JvmStatic
        var isForgotPasswordFragmentDisplay = false
    }
    ...
    override fun onCreate() {
        Timer().schedule(1000){ isReady = true }
        displaySplash()
